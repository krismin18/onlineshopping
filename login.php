...
?>
	<main class="jumbotron d-flex align-items-center primary-background banner-background " style="height: 85vh;">
		<div class="container" >
			...
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="card">
						...
						<div>
						    <div class="card-body">
							    <form method="post"  name="loginform" action="authenticate.php">
